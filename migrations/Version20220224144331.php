 ...
 */
final class Version20220224144331 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, datetime DATETIME NOT NULL, country VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, cp VARCHAR(255) NOT NULL, street VARCHAR(255) NOT NULL, ics_file LONGTEXT DEFAULT NULL, description LONGTEXT DEFAULT NULL, mails_to_remind LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', image VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, ticketing_link LONGTEXT DEFAULT NULL, tags LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE music (id INT AUTO_INCREMENT NOT NULL, album_id INT DEFAULT NULL, titre VARCHAR(255) DEFAULT NULL, duration INT DEFAULT NULL, musicname VARCHAR(255) DEFAULT NULL, audio_size INT DEFAULT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_CD52224A1137ABCF (album_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
